...
part 'src/model/preference_idb.dart';
...
part 'src/model/stat_by.dart';
part 'src/model/stat_calc.dart';
part 'src/model/stat_match.dart';
part 'src/model/stat_point.dart';
