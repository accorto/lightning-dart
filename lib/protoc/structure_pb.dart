...
class DTable extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DTable')
    ..a/*<String>*/(1, 'tableId', PbFieldType.OS)
    ...
    ..a/*<String>*/(7, 'color', PbFieldType.OS)
    ..a/*<String>*/(8, 'externalKey', PbFieldType.OS)
    ..a/*<bool>*/(9, 'isActive', PbFieldType.OB, true)
    ..pp/*<DColumn>*/(10, 'column', PbFieldType.PM, DColumn.$checkItem, DColumn.create)
    ..a/*<String>*/(11, 'readOnlyLogic', PbFieldType.OS)
    ..a/*<String>*/(15, 'iconImage', PbFieldType.OS)
    ..a/*<bool>*/(20, 'isReadOnly', PbFieldType.OB)
    ..a/*<bool>*/(21, 'isNewRecordServer', PbFieldType.OB)
    ..a/*<String>*/(26, 'note', PbFieldType.OS)
...
class DColumn extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DColumn')
    ...
    ..a/*<String>*/(2, 'name', PbFieldType.QS)
    ..a/*<String>*/(3, 'label', PbFieldType.OS)
    ..a/*<String>*/(4, 'labelSuffix', PbFieldType.OS)
    ..a/*<String>*/(5, 'description', PbFieldType.OS)
    ..a/*<bool>*/(7, 'isActive', PbFieldType.OB, true)
    ..a/*<String>*/(8, 'columnSql', PbFieldType.OS)
    ..a/*<String>*/(9, 'externalKey', PbFieldType.OS)
    ..e/*<DataType>*/(10, 'dataType', PbFieldType.QE, DataType.STRING, DataType.valueOf)
    ..a/*<int>*/(11, 'columnSize', PbFieldType.O3)
    ..a/*<int>*/(12, 'decimalDigits', PbFieldType.O3)
    ..a/*<bool>*/(20, 'isEncrypted', PbFieldType.OB)
    ..a/*<String>*/(21, 'defaultValue', PbFieldType.OS)
    ..a/*<String>*/(22, 'formatMask', PbFieldType.OS)
    ..a/*<String>*/(23, 'valFrom', PbFieldType.OS)
    ..a/*<String>*/(24, 'valTo', PbFieldType.OS)
    ..a/*<String>*/(25, 'help', PbFieldType.OS)
    ..a/*<String>*/(26, 'note', PbFieldType.OS)
    ..a/*<String>*/(27, 'validationCallout', PbFieldType.OS)
    ..a/*<bool>*/(28, 'isDocumentNo', PbFieldType.OB)
    ..a/*<bool>*/(30, 'isMandatory', PbFieldType.OB)
    ..a/*<bool>*/(31, 'isReadOnly', PbFieldType.OB)
    ..a/*<bool>*/(32, 'isUpdateAlways', PbFieldType.OB)
    ..a/*<bool>*/(33, 'isTranslated', PbFieldType.OB)
    ..a/*<bool>*/(34, 'isTranslation', PbFieldType.OB)
    ..a/*<bool>*/(35, 'isCopied', PbFieldType.OB, true)
    ..a/*<bool>*/(36, 'isCalculated', PbFieldType.OB)
    ..a/*<String>*/(38, 'processExternalKey', PbFieldType.OS)
    ..a/*<bool>*/(39, 'isSynonym', PbFieldType.OB)
    ..a/*<bool>*/(40, 'isPk', PbFieldType.OB)
    ..a/*<bool>*/(41, 'isParentKey', PbFieldType.OB)
    ..a/*<String>*/(42, 'fkReference', PbFieldType.OS)
    ..a/*<String>*/(43, 'parentColumnId', PbFieldType.OS)
    ..a/*<String>*/(44, 'parentReference', PbFieldType.OS)
    ..a/*<String>*/(45, 'restrictionSql', PbFieldType.OS)
    ..a/*<String>*/(46, 'pickListId', PbFieldType.OS)
    ..a/*<String>*/(47, 'pickListName', PbFieldType.OS)
    ..a/*<int>*/(48, 'pickListSize', PbFieldType.O3)
    ..a/*<bool>*/(49, 'isPickListExtensible', PbFieldType.OB)
    ..a/*<int>*/(50, 'uniqueSeqNo', PbFieldType.O3)
    ..a/*<int>*/(51, 'displaySeqNo', PbFieldType.O3)
    ..pp/*<DOption>*/(60, 'pickValue', PbFieldType.PM, DOption.$checkItem, DOption.create)
    ..a/*<String>*/(61, 'tempExternalKey', PbFieldType.OS)
    ..a/*<String>*/(63, 'updateFlag', PbFieldType.OS)
  ;
...
class DOption extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DOption')
    ...
    ..a/*<String>*/(3, 'label', PbFieldType.QS)
    ..a/*<String>*/(4, 'description', PbFieldType.OS)
    ..a/*<String>*/(5, 'iconImage', PbFieldType.OS)
    ..a/*<bool>*/(6, 'isSelected', PbFieldType.OB)
    ..a/*<bool>*/(7, 'isOptGroup', PbFieldType.OB)
    ..a/*<int>*/(10, 'seqNo', PbFieldType.O3)
    ..a/*<bool>*/(11, 'isActive', PbFieldType.OB, true)
    ..a/*<bool>*/(12, 'isDefault', PbFieldType.OB)
    ..a/*<String>*/(15, 'referenceId', PbFieldType.OS)
    ..a/*<String>*/(16, 'cssClass', PbFieldType.OS)
    ..a/*<String>*/(17, 'cssColor', PbFieldType.OS)
    ..pp/*<DKeyValue>*/(20, 'validation', PbFieldType.PM, DKeyValue.$checkItem, DKeyValue.create)
    ..p/*<String>*/(21, 'valueSynonym', PbFieldType.PS)
    ..a/*<String>*/(30, 'updateFlag', PbFieldType.OS)
  ;
...
class DProperty extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DProperty')
    ...
    ..a/*<String>*/(4, 'description', PbFieldType.OS)
    ..a/*<String>*/(5, 'help', PbFieldType.OS)
    ..a/*<int>*/(6, 'seqNo', PbFieldType.O3)
    ..a/*<bool>*/(7, 'isRange', PbFieldType.OB)
    ..a/*<bool>*/(8, 'isMandatory', PbFieldType.OB, true)
    ..a/*<bool>*/(9, 'isReadOnly', PbFieldType.OB)
    ..e/*<DataType>*/(10, 'dataType', PbFieldType.OE, DataType.STRING, DataType.valueOf)
    ..a/*<int>*/(11, 'columnSize', PbFieldType.O3)
    ..a/*<int>*/(12, 'decimalDigits', PbFieldType.O3)
    ..a/*<String>*/(13, 'defaultValue', PbFieldType.OS)
    ..a/*<String>*/(14, 'defaultValueTo', PbFieldType.OS)
    ..a/*<String>*/(15, 'pickListName', PbFieldType.OS)
    ..pp/*<DOption>*/(16, 'pickValue', PbFieldType.PM, DOption.$checkItem, DOption.create)
    ..a/*<String>*/(20, 'formatMask', PbFieldType.OS)
    ..a/*<String>*/(21, 'valFrom', PbFieldType.OS)
    ..a/*<String>*/(22, 'valTo', PbFieldType.OS)
    ..a/*<String>*/(23, 'fkReference', PbFieldType.OS)
    ..a/*<String>*/(30, 'value', PbFieldType.OS)
    ..a/*<String>*/(31, 'valueTo', PbFieldType.OS)
    ..a/*<bool>*/(32, 'isChanged', PbFieldType.OB)
    ..a/*<String>*/(33, 'valueOriginal', PbFieldType.OS)
    ..a/*<bool>*/(34, 'isValid', PbFieldType.OB, true)
    ..a/*<String>*/(40, 'updateFlag', PbFieldType.OS)
  ;
...
class DTrxState extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DTrxState')
    ..a/*<String>*/(1, 'id', PbFieldType.OS)
    ..a/*<String>*/(2, 'name', PbFieldType.QS)
    ..a/*<String>*/(3, 'tenantId', PbFieldType.OS)
    ..a/*<String>*/(5, 'tableId', PbFieldType.OS)
    ..a/*<String>*/(6, 'tableName', PbFieldType.OS)
    ..a/*<bool>*/(7, 'isDefault', PbFieldType.OB)
    ..a/*<String>*/(9, 'chartUrl', PbFieldType.OS)
    ..pp/*<DTrxStatus>*/(10, 'status', PbFieldType.PM, DTrxStatus.$checkItem, DTrxStatus.create)
    ..pp/*<DTrxAction>*/(11, 'action', PbFieldType.PM, DTrxAction.$checkItem, DTrxAction.create)
  ;
...
class DTrxStatus extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DTrxStatus')
    ...
    ..a/*<String>*/(2, 'value', PbFieldType.QS)
    ..a/*<String>*/(3, 'label', PbFieldType.QS)
    ..a/*<int>*/(4, 'seqNo', PbFieldType.O3)
    ..a/*<bool>*/(5, 'isInitialState', PbFieldType.OB)
    ..a/*<bool>*/(6, 'isFinalState', PbFieldType.OB)
    ..a/*<bool>*/(7, 'isError', PbFieldType.OB)
    ..a/*<bool>*/(8, 'isDocRw', PbFieldType.OB)
    ..p/*<String>*/(10, 'actionId', PbFieldType.PS)
    ..pp/*<DTrxAction>*/(11, 'action', PbFieldType.PM, DTrxAction.$checkItem, DTrxAction.create)
  ;
...
class DTrxAction extends GeneratedMessage {
  static final BuilderInfo _i = new BuilderInfo('DTrxAction')
    ...
    ..a/*<String>*/(3, 'label', PbFieldType.QS)
    ..a/*<int>*/(4, 'seqNo', PbFieldType.O3)
    ..a/*<String>*/(5, 'statusId', PbFieldType.OS)
  ;
