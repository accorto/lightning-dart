...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static lObjectCtrl1Record() => "Eine Rekord";

  static lObjectCtrlDelete1Record() => "Aktuellen Datensatz löschen";

  static lObjectCtrlDelete1RecordText() => "Möchten Sie den aktuellen Datensatz löschen?";

  static lObjectCtrlDeleteRecords() => "Ausgewählte löschen Rekorde?";

  static lObjectCtrlDeleteRecordsText() => "Möchten Sie die ausgewählten Datensätze löschen?";

  static lObjectCtrlNoRecordInfo() => "Es werden keine Aufzeichnungen angezeigt werden - ändern Filtern oder neue";

  static lObjectCtrlNoRecords() => "No records";

  static lObjectCtrlRecords() => "Aufzeichnungen";

  static lObjectCtrlSortedBy() => "Sortiert nach";

  static lObjectHomeFilterList() => "Filterliste";

  static lObjectHomeFilterListAll() => "Alle Aufzeichnungen";

  static lObjectHomeFilterListRecent() => "Zuletzt angesehen";
  ...
  static lObjectHomeLookupList() => "Verzeichnis";
